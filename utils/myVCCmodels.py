...
def myVCCmodel(Tevap, Tcond, SH, SC, n, fluid):
    ...
    # input checking
    if  n <= 0 or n > 1:
        print('Problem: n should be specified 0 < n =< 1. Check calculations.')
        return 

    if SC < 0:
        print('Problem: can not specify negative value. Check calculations.')
        return
    ...
    T3 = Tcond - SC
    P3 = PropsSI("P", "T", Tcond, "Q", 0, fluid) # should be same as using Q=1
